<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<jsp:useBean id="calc" class="jspbook.pr42.Calculator" scope="page"/>
...
<form>
		<table style="margin-left: auto; margin-right: auto;" width="600" height="100">
			...
			<tr><td width="300">
				<input type="text" size="10" name = "num1" value="${calc.op1}" readonly>
				<br><br>
				<select name="op">
						<option value="+">+</option>
						<option value="-">-</option>
				...
				<br><br><input type="text" size="10" name = "num2" value="${calc.op2}" readonly>
